...
void main() {
  group('RecordingClip', () {
    ...
    group('path round-trip for rendered videos', () {
      test(
        'round-trip resolves to documents directory '
        'when video is in documents directory',
        () async {
          const documentsPath = '/var/mobile/Documents';
          final clip = RecordingClip(
            id: 'rendered-clip',
            video: EditorVideo.file(
              '$documentsPath/divine_123456.mp4',
            ),
      ...
      test(
        'round-trip does NOT resolve to original path '
        'when video is in temp directory',
        () async {
          ...
          expect(
            restoredPath,
            equals('$documentsPath/divine_123456.mp4'),
          );
        },
      );
    });
