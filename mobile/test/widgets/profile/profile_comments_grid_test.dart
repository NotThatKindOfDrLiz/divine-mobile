        ...
        (tester) async {
          when(() => mockBloc.state).thenReturn(
            ProfileCommentsState(
              ...
              textComments: [
                _createComment(id: 't1'),
                _createComment(id: 't2'),
              ],
            ),
          );
          ...
          expect(find.text('Comment t1'), findsOneWidget);
          expect(find.text('Comment t2'), findsOneWidget);
        },
      );
      ...
      testWidgets(
        ...
        (tester) async {
          when(() => mockBloc.state).thenReturn(
            ProfileCommentsState(
              status: ProfileCommentsStatus.success,
              textComments: [_createComment(id: 't1')],
              isLoadingMore: true,
            ),
          );
    ...
    group('interactions', () {
      testWidgets('dispatches load more when scrolled near bottom', (
        ...
        final manyComments = List.generate(
          20,
          (i) => _createComment(id: 't$i', createdAtSeconds: 1700000000 - i),
        );
      ...
      testWidgets('navigates to video when text comment is tapped', (
        ...
        await tester.tap(find.text('Comment t1'));
        await tester.pumpAndSettle();
