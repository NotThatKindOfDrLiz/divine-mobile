// ABOUTME: Tests for CameraMobileService
// ABOUTME: Validates mobile camera service initialization and methods
//
...
void main() {
  ...
  group('CameraMobileService Tests', () {
    ...
    group('Flash Control', () {
      test('setFlashMode returns Future<bool>', () {
        final result = service.setFlashMode(FlashMode.auto);
