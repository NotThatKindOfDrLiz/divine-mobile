...
// ABOUTME: Blocking gate before signup - persists acceptance to SharedPreferences
...
class LegalScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return BlocProvider(
      create: (_) => LegalCubit(sharedPreferences: prefs)..loadSavedState(),
                ...
                text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()
                        ..onTap = () => onOpenUrl('https://divine.video/safety'),
                    ),
                  ],
                ),
              ),
