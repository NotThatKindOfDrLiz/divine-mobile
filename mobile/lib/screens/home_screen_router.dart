// ABOUTME: Router-driven HomeScreen using individual VideoFeedItem widgets
// ABOUTME: Pure presentation with no lifecycle mutations - URL is source of
// ABOUTME: truth, each video manages its own controller via Riverpod
  ...
  Widget build(BuildContext context) {
    ...
    return buildAsyncUI(
      ...
      onData: (state) {
        ...
        // Prefetch profiles for adjacent videos (+/-1 index) only when
        // URL index changes
        if (urlIndex != _lastPrefetchIndex) {
          ...
          // Schedule prefetch for next frame to avoid doing work during
          // build
        ...
        return RefreshIndicator(
          ...
          child: PageView.builder(
            ...
            onPageChanged: (newIndex) {
              ...
              // Dispose controllers outside keep range to free memory
